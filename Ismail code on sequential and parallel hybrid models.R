...
# Load the data
climatedata <- read.csv("climatedatanew3.csv", header = TRUE, na.strings = "?")
...
leaky_relu <- function(x, alpha = 0.09) {
  keras::k_relu(x, alpha = alpha)
}
# Build LSTM model function with fixed parameters
build_lstm_model <- function(units = 200, learning_rate = 0.00001, optimizer = 'nadam', activation = 'relu', recurrent_activation = leaky_relu, batch_size = 32, epochs = 150) {
...
build_gru_model <- function(units = 200, learning_rate = 0.0001, optimizer = 'nadam', activation = 'tanh', recurrent_activation = 'hard_tanh', batch_size = 32, epochs = 150){
  input_layer <- layer_input(shape = c(ncol(x_train), 1))
...
build_parallel_lstm_gru_model <- function(units = 150, learning_rate = 0.00001, activation = 'relu', recurrent_activation = 'gelu', batch_size = 16, epochs = 150) {
  input_layer <- layer_input(shape = c(ncol(x_train), 1))
